...
$(document).ready(function () {
    ...
    then add to the new degree*/
        ...
        if ((times % everyXtime) == 0) {
            totalDegree = 3600;
            setTimeout(function () {
                $("#confetti").css('z-index', '10');
                $("#winner").show('fast');
                $("#question").hide();
                $("#wheel").hide();
            }, 7000);
            setTimeout(function () {
                BM.setTransactionValue('#lucky:yes', 'yes');
                BM.setTransactionValue('#fulfilled:yes', "10");
                BM.goToStep(11);
            }, 12000);
        } else {
            setTimeout(function () {
                BM.setTransactionValue('#fulfilled:yes', "15");
                BM.setTransactionValue('#lucky:no', 'no');
                BM.goToStep(12);
            }, 7000);
            totalDegree = 3660;
        }
